...
<body>
    ...
    <nav id="sidebar" class="">
        <div class="sidebar-header">
            <a href="index.html"><img class="main-logo" src="img/logo/logo.png" height="50px" width="150px" alt="" /></a>
        </div>
...
if(isset($_POST["cmdaddnew"])){
 $sql = "INSERT INTO adherent (nom,prenom, date_naissance, mail, specialite,date_adhesion,date_fin_adhesion,tel,adresse,cotisation_annuaire,date_payement,id_service)
 VALUES ('".$_POST["nom"]."','".$_POST["prenom"]."','".$_POST["date_naissance"]."','".$_POST["mail"]."','".$_POST["specialite"]."','".$_POST["date_adhesion"]."','".$_POST["date_fin_adhesion"]."','".$_POST["tel"]."','".$_POST["adresse"]."','".$_POST["cotisation_annuaire"]."','".$_POST["date_payement"]."','".$_POST["id_service"]."')";
...
if(isset($_POST["cmdedit"])){
   ...
   $sql = "UPDATE adherent SET nom='$editname', prenom  ='$editname',  date_naissance='$editemail', mail='$editaddress' WHERE id='$editemployee'";
...
<?php
    ...
    if(count($_POST)>0)
    {
        $roll_no=$_POST['prenom'];
        $result = mysqli_query($conn,"SELECT * FROM adherents where prenom='$roll_no' ");
    }
?>
