	...
	<div class="container-fluid">
		<div class="container">
			<div class="row m-3 text-center">
				<div class="col-lg-12">
					<h1 class="box-title">Listes Des Adherents</h1>
				</div>
			</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		  	...
		  	<div class="form-group">
				...
				<input type="date" class="form-control" name="date_naissance" id="upd_3" placeholder="Date_Naissance">
		  	...
		  	<div class="form-group">
				...
				<input type="text" class="form-control" name="mail" id="upd_4" placeholder="Mail">
