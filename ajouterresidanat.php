                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                                <a class="" href="residanat.php">
                                       <span class="educate-icon educate-home icon-wrap"></span>
                                       <span class="mini-click-non">Résidanat</span>
                                    </a>
...
<p> Residanat enregistré avec succès</p>
</div>
<?php 
...
<h2 class="ajouter"> Ajouter Résidanat</h2> <br>
    ...
    <form action="ajouterresidanat.php" method="POST">
        ...
        <tr>
            <td>Thème :</td>
            <td><input type="text" name="Theme" placeholder="Thème" required></td>
            </tr>
        ...
        <tr>
        <td> Intitulé : </td>
        <td><input type="text" name="Intitule" placeholder="Intitulé" required></td>
        </tr>
        <tr>
