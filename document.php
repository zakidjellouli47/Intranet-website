...
<div >
<br><br><br><br>
<h2 class="ajouter"> Ajouter Document</h2> <br>
    ...
    <form action="upload1.php" method="POST" enctype ="multipart/form-data" >
        ...
        <tr>
            ...
            <td><select required class="document" name="document">
                <option value="">-----</option>
                <option value="Homme">Bilans</option>
                <option value="Homme">PV</option>
                <option value="Femme">Pv de réunion</option>
                </select></td>
            </tr>
        ...
        <td><input  name="datee" type="date" max="{{datemin}}" required title="du type AAAA-MM-JJ et vous devez avoir 18 ans minimum" placeholder="exemple 1901-01-01" pattern="19[0-9]{2}-[0-9]{2}-[0-9]{2}"/>
                ...
                <tr>
                        <td> Fichier: </td>
                        <td><input name="fichier" class="avatar" type="file" id="avatar" required></td>
                        </tr>
                        <tr>
        ...
        <tr>
        <td colspan="2" align="center"><button type="submit" id="button" name="btn" value="pl" > Ajouter </td>
        </tr>
        </table>
        </form>
...
//https://www.startimes.com/f.aspx?t=10557467